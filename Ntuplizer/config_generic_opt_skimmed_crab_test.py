...
#options.inputFiles = 'file:///pnfs/psi.ch/cms/trivcat/store/user/jinw/MinBiasMC/01CAAE7C-C5A9-8B4E-9CEA-188884ED0FC2.root'
#options.inputFiles = 'file:///pnfs/psi.ch/cms/trivcat/store/user/jinw/MinBiasMC/74909027-AEC8-7B4A-AC35-158FEF524C4D.root'
#options.inputFiles = 'file:///work/kcormier/instantons/miniAODs/herwig/instanton_H7_miniAOD_9.root' 
#options.inputFiles = 'file:///work/kcormier/instantons/miniAODs/sherpa/instanton_sherpa_miniAOD_19.root'
#options.inputFiles = 'file:///work/kcormier/instantons/hepmc/privateGenProds/run/h7_nopileup/output_0/step_5.root'
#options.inputFiles = 'file:///work/kcormier/instantons/hepmc/privateGenProds/run/sherpa_4f_m100GeV_wMPI_noPU/output_0/step_5.root'
...
#inputlist = ["file://"+f for f in glob.glob("/pnfs/psi.ch/cms/trivcat/store/user/kcormier/instantons/instantons/miniAODs/sherpa_4f_m10to20GeV_wMPI_noPU/*.root")]
#inputlist = ["file://"+f for f in glob.glob("/pnfs/psi.ch/cms/trivcat/store/user/kcormier/instantons/instantons/miniAODs/sherpa_4f_m10to20GeV_wMPI_noPU/*.root")]
#inputlist = ["file:///pnfs/psi.ch/cms/trivcat/store/user/kcormier/instantons/instantons/miniAODs/sherpa_4f_m100GeV_noPU/instanton_sherpa_4f_m100GeV_noPU_miniAOD_2.root"]
#inputlist = ["file:///work/kcormier/instantons/hepmc/privateGenProds/run/sherpa_4f_m100GeV_noMPI_noPU_test/output_0/step_5.root"]
#inputlist = ["/store/mc/RunIIAutumn18MiniAOD/MinBias_NoFilter_SoftQCDnonD_TuneCP5_13TeV-pythia8/MINIAODSIM/102X_upgrade2018_realistic_v15-v2/270000/74909027-AEC8-7B4A-AC35-158FEF524C4D.root",
...
#options.inputFiles = 'file:///work/kcormier/instantons/hepmc/privateGenProds/run/h7_realisticVtx100/output_1/step_5.root'
#options.inputFiles = 'file:///pnfs/psi.ch/cms/trivcat/store/user/jinw/HardQCD2018/0132101A-3696-6D48-A7AC-2B6B1D2E6139.root'
#options.inputFiles = 'file:///pnfs/psi.ch/cms/trivcat/store/user/jinw/HardQCD2018/054D0C14-97DE-654B-8FCC-66C8038A7E96.root'
#options.inputFiles = 'file:///pnfs/psi.ch/cms/trivcat/store/user/jinw/HardQCDMC2018_NoPU/00272A55-D6D7-014D-AE1C-BA1B4E6B3539.root'
...
process.ntuplizer = cms.EDAnalyzer("Ntuplizer",
    ...
    runOnHerwigInstanton  = cms.bool(config["RUNONHERWIGINSTANTON"]),
    runOnSherpaInstanton  = cms.bool(config["RUNONSHERPAINSTANTON"]),
    runOnMCTest       = cms.bool(config["RUNONMCTEST"]),
    runOnMCPU         = cms.bool(config["RUNONMCPU"]),
    runOnZeroBias     = cms.bool(config["RUNONZEROBIAS"]),
...
#    gentaus = cms.InputTag("tauGenJets"),
    ...
    genEventInfo = cms.InputTag("source","generator") if (cms.bool(config["RUNONMC"]) and (cms.bool(config["RUNONHERWIGINSTANTON"]) or cms.bool(config["RUNONSHERPAINSTANTON"]) or cms.bool(config["RUNONMCTEST"]))) else cms.InputTag("generator"),

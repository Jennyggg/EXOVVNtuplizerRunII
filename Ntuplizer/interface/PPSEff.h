...
class PPSEff
{
	...
	bool InFiducial(int arm, int det, unsigned int runNumber, float x, float y){
		...
		if(runNumber>=306936&& runNumber<=307082) era="2017H";
                if(runNumber>=315252&& runNumber<=316995) era="2018A";
                if(runNumber>=316998&& runNumber<=317696) era="2018B1";
                if(runNumber>=318622&& runNumber<=319312) era="2018B2";
                if(runNumber>=319313&& runNumber<=320393) era="2018C";
                if(runNumber>=320394&& runNumber<=322633) era="2018D1";
                if(runNumber>=323363&& runNumber<=325273) era="2018D2";

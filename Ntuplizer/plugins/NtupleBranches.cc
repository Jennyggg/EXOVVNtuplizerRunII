...
//    tree_->Branch("Instanton_N_Trk_goodDisplaced_fromPV2_highPurity_sig3_pt1",&Instanton_N_Trk_goodDisplaced_fromPV2_highPurity_sig3_pt1);
    tree_->Branch("Instanton_N_Trk_formSV_sig2", &Instanton_N_Trk_formSV_sig2);
    tree_->Branch("Instanton_N_Trk_formSV_sig3", &Instanton_N_Trk_formSV_sig3);
    tree_->Branch("Instanton_N_Trk_formSV_sig5", &Instanton_N_Trk_formSV_sig5);
    tree_->Branch("Instanton_N_SV_sig2", &Instanton_N_SV_sig2);
    tree_->Branch("Instanton_N_SV_sig3", &Instanton_N_SV_sig3);
    tree_->Branch("Instanton_N_SV_sig5", &Instanton_N_SV_sig5);
    tree_->Branch("Instanton_N_Trk_DisplaceVp002", &Instanton_N_Trk_DisplaceVp002);
    tree_->Branch("Instanton_N_Trk_DisplaceVp002_SVsig2",&Instanton_N_Trk_DisplaceVp002_SVsig2);
...
//  Instanton_N_Trk_goodDisplaced_fromPV2_highPurity_sig3_pt1.clear();
  Instanton_N_SV_sig2.clear();
  Instanton_N_SV_sig3.clear();
  Instanton_N_SV_sig5.clear();
  Instanton_N_Trk_DisplaceVp002.clear();
  Instanton_N_Trk_DisplaceVp002_SVsig2.clear();
  Instanton_N_SV_default=0;
  Instanton_N_Trk_formSV_sig2.clear();
  Instanton_N_Trk_formSV_sig3.clear();
  Instanton_N_Trk_formSV_sig5.clear();

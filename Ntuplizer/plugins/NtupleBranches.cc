...
//    tree_->Branch("JpsiTau_ed_genpt", &JpsiTau_ed_genpt);
  ...
  if (runFlags["doInstanton"]){
    ...
    tree_->Branch("Instanton_N_Trk_highPurity_pt1",&Instanton_N_Trk_highPurity_pt1);
...
//    tree_->Branch("Instanton_N_Trk_PVAssociationQuality7",&Instanton_N_Trk_PVAssociationQuality7);
    ...
    tree_->Branch("Instanton_N_Trk_PVAssociationQualityLeq4_highPurity_pt1",&Instanton_N_Trk_PVAssociationQualityLeq4_highPurity_pt1); 
    ...
    tree_->Branch("Instanton_N_Trk_Displaced_highPurity_pt1",&Instanton_N_Trk_Displaced_highPurity_pt1);
...
//    tree_->Branch("Instanton_N_Trk_Displaced_PVAssociationQuality7",&Instanton_N_Trk_Displaced_PVAssociationQuality7);
    ...
    tree_->Branch("Instanton_N_Trk_Displaced_PVAssociationQualityLeq4_highPurity_pt1",&Instanton_N_Trk_Displaced_PVAssociationQualityLeq4_highPurity_pt1);
...
//    tree_->Branch("Instanton_N_Trk_goodDisplaced_fromPV2_highPurity_sig3_pt1",&Instanton_N_Trk_goodDisplaced_fromPV2_highPurity_sig3_pt1);
    ...
    tree_->Branch("Instanton_N_Trk_goodDisplaced_highPurity_pt1",&Instanton_N_Trk_goodDisplaced_highPurity_pt1);
...
//    tree_->Branch("Instanton_N_Trk_goodDisplaced_PVAssociationQuality7",&Instanton_N_Trk_goodDisplaced_PVAssociationQuality7);
    ...
    tree_->Branch("Instanton_Trk_TrkCut_pt1_pt",&Instanton_Trk_TrkCut_pt1_pt);
...
//    tree_->Branch("TrackJet_TrkCut_P4",&TrackJet_TrkCut_P4);
    ...
    tree_->Branch("Instanton_Trk_TrkCut_pt1_mass",&Instanton_Trk_TrkCut_pt1_mass);
    ...
    tree_->Branch("Instanton_Trk_TrkCut_pt1_ptmiss",&Instanton_Trk_TrkCut_pt1_ptmiss);
...
//    tree_->Branch("Instanton_TrackJet_TrkCut_pt1_pz",&Instanton_TrackJet_TrkCut_pt1_pz);
    ...
    tree_->Branch("Instanton_Trk_TrkCut_pt1_spherocity",&Instanton_Trk_TrkCut_pt1_spherocity);
    tree_->Branch("Instanton_Trk_TrkCut_pt1_broaden",&Instanton_Trk_TrkCut_pt1_broaden);
    tree_->Branch("Instanton_Trk_TrkCut_pt1_thrust",&Instanton_Trk_TrkCut_pt1_thrust);
    ...
    else tree_->Branch("Instanton_N_genPromptHeavyQ",&Instanton_N_genPromptHeavyQ);
...
//  JpsiTau_hammer_ebe_d2_down.clear();
  ...
  Instanton_N_Trk_highPurity_pt1.clear();
...
//  Instanton_N_Trk_PVAssociationQuality7.clear();
  ...
  Instanton_N_Trk_PVAssociationQualityLeq4_highPurity_pt1.clear();
  ...
  Instanton_N_Trk_Displaced_highPurity_pt1.clear();
...
//  Instanton_N_Trk_Displaced_PVAssociationQuality7.clear();
  ...
  Instanton_N_Trk_Displaced_PVAssociationQualityLeq4_highPurity_pt1.clear();
...
//  Instanton_N_Trk_goodDisplaced_fromPV2_highPurity_sig3_pt1.clear();
  ...
  Instanton_N_Trk_goodDisplaced_highPurity_pt1.clear();
...
//  Instanton_TrackJet_TrkCut_pt1_pz.clear();
  ...
  Instanton_Trk_TrkCut_pt1_spherocity.clear();
  Instanton_Trk_TrkCut_pt1_broaden.clear();
  Instanton_Trk_TrkCut_pt1_thrust.clear();

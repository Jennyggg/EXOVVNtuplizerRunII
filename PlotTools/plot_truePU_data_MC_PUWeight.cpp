#include "helper.cpp"
void plot_truePU_data_MC_PUWeight(string MCname,string dataname, string PUWeight_tree, string plotname, string MClegend,string datalegend,string selectionMC="", string selectiondata="",bool PUreweight = true, bool isLog = false){
  int nbins=65;
  float min=0;
  float max=65;

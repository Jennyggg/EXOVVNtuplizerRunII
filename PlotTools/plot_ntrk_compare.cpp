#include "helper.cpp"
void plot_ntrk_compare(string filenames_1,string filenames_2, string plotname, string legendname_1,string legendname_2,string massregion = "inclu", string insta_lumi = "inclu", bool isLog = false){
  int nbins=85;
  float min=0.;
  float max=170.;
...
*/
  ...
  pad1->Update();
  c->Update();
  plotname += "_"+massregion+"_ntrk_runmerge_lumi"+insta_lumi;

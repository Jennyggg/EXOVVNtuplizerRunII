#include "helper.cpp"
void plot_thrust_compare(string filenames_1,string filenames_2, string plotname, string legendname_1,string legendname_2,string massregion = "inclu", string insta_lumi = "inclu", bool isLog = false){
  int nbins=20;
  float min=0.;
  float max=0.5;
...
*/
  ...
  pad1->Update();
  c->Update();
  plotname += "_"+massregion+"_thrust_runmerge_lumi"+insta_lumi;
